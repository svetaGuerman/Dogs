...
(lib._1727490 = function() {
	this.initialize(ss["Dogs_Yarin Yael Sveta_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.DogsYarinYaelSveta = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/Dogs_Yarin Yael Sveta_atlas_1.png?1633362450913", id:"Dogs_Yarin Yael Sveta_atlas_1"}
	],
	preloads: []
};
